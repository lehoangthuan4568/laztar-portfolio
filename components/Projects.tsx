        ...
        {projects.map((project) => (
          <a
            ...
            {...(project.external
              ...
              : {})}
            className="group block rounded-2xl border border-[var(--border)] bg-[var(--card)] overflow-hidden card-lift opacity-0 animate-fade-up"
          >
            ...
            <div className="p-5 sm:p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Title */}
                  <h3 className="font-semibold text-[var(--text)] group-hover:text-[var(--accent)] transition-colors text-base sm:text-lg">
                    {project.title}
                    {project.external && (
